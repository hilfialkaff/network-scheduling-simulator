...
def main():
    # num_ports = [6, 7, 8, 9]
    # num_hosts = [45, 61, 80, 101] # Number of host nodes in the topology
    # ft_num_hosts = [54, 63, 128, 144] # Number of host nodes in fat-tree topology
    # num_switches = [45, 61, 80, 101] # Number of switches in the topology
    # num_mr = [2, 3, 4] # Number of maps/reducers
